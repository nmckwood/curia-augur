...
class Constituency {
  ...
  /// Every deprivation delta the analysis carries: 8 rank (percentile-point
  /// floats) and 8 decile (ints). The prediction stage rebuilds its feature
  /// matrix from these, so all 16 are present.
  final Map<String, num> deciles;
  final double pcaX;
  final double pcaY;
  final int
  ...
  factory Constituency.fromJson(Map<String, dynamic> json) => Constituency(
    ...
    deciles:
        ((json['deprivation'] ?? <String, dynamic>{})
